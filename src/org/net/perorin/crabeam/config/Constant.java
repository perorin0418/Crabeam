...
public class Constant {
	...
	public static String CURSOR_MOVE = "./contents/image/cursor/move.png";
	public static String CURSOR_EXPAND_VERTICAL = "./contents/image/cursor/expand_v.png";
	public static String CURSOR_EXPAND_HORIZONTAL = "./contents/image/cursor/expand_h.png";
	public static String CURSOR_EXPAND_VER_HOR = "./contents/image/cursor/expand_vh.png";
