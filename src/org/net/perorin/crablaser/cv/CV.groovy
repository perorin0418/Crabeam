package org.net.perorin.crablaser.cv
...
import org.net.perorin.crablaser.exception.CVException
...
public class CV {
	...
	public static CVImage setFrame(CVImage img, Color edgeColor) {
		WritableRaster wr = img.getImageRaster()
		int[] color = new int[4]
		color[0] = edgeColor.getRed()
		color[1] = edgeColor.getGreen()
		color[2] = edgeColor.getBlue()
		color[3] = edgeColor.getAlpha()
